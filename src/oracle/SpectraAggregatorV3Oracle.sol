...
contract SpectraAggregatorV3Oracle is IOracle, AccessControlUpgradeable, UUPSUpgradeable {
    /*//////////////////////////////////////////////////////////////
                               ERRORS
    //////////////////////////////////////////////////////////////*/
    error SpectraAggregatorV3Oracle__spot_invalidValue();
    error SpectraAggregatorV3Oracle__authorizeUpgrade_validStatus();
    /*//////////////////////////////////////////////////////////////
                               CONSTANTS
    //////////////////////////////////////////////////////////////*/
    ...
    /// @notice Spectra 
    ERC4626 public immutable spectraIBT;
    ...
    constructor(address curvePool_, address spectraIBT_, AggregatorV3Interface aggregator_,
        uint256 stalePeriod_) initializer {
        spectraIBT = ERC4626(spectraIBT_);
    ...
    function _authorizeUpgrade(address /*implementation*/) internal virtual override onlyRole(MANAGER_ROLE) {
        if (_getStatus()) revert SpectraAggregatorV3Oracle__authorizeUpgrade_validStatus();
    }
    ...
    function spot(address /* token */) external view virtual override returns (uint256 price) {
        ...
        if (!isValid) revert SpectraAggregatorV3Oracle__spot_invalidValue();
        uint256 spectraIBTVirtualPrice = _fetchVirtualPrice();
        return wmul(price,spectraIBT.convertToAssets(spectraIBTVirtualPrice));
    }
