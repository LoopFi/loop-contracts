...
contract CDPVaultHandler is BaseHandler {
    ...
    constructor(InvariantTestBase testContract_, CDPVaultWrapper vault_, GhostVariableStorage ghostStorage_) BaseHandler("CDPVaultHandler", testContract_, ghostStorage_) {
        vault = vault_;
