...
contract CDPVaultSpectra is AccessControl, Pause, Permission, ICDPVaultBase {
    /*//////////////////////////////////////////////////////////////
                               LIBRARIES
    //////////////////////////////////////////////////////////////*/
    ...
    function claimSpectraRewards(
        ...
        if (address(rewardManager) != address(0)) {
            ICampaignManager(rewardManager.campaignManager()).claim(
                address(token),
                rewardToken,
                earnedAmount,
                claimAmount,
        ...
        rewardManager.updateIndexRewards();
    }
}
